...
{
    // ADC:
    setOp(M6502_INST::INS_ADC,0x69,M6502_ADDRMODE::ADR_IMM,2,2);
    setOp(M6502_INST::INS_ADC,0x65,M6502_ADDRMODE::ADR_ZP,2,3);
    setOp(M6502_INST::INS_ADC,0x75,M6502_ADDRMODE::ADR_ZPX,2,4);
    setOp(M6502_INST::INS_ADC,0x6D,M6502_ADDRMODE::ADR_ABS,3,4);
    setOp(M6502_INST::INS_ADC,0x7D,M6502_ADDRMODE::ADR_ABSX,3,4);
    setOp(M6502_INST::INS_ADC,0x79,M6502_ADDRMODE::ADR_ABSY,3,4);
    setOp(M6502_INST::INS_ADC,0x61,M6502_ADDRMODE::ADR_PREIDXIND,2,6);
    setOp(M6502_INST::INS_ADC,0x71,M6502_ADDRMODE::ADR_POSTIDXIND,2,5);

    // AND:
    setOp(M6502_INST::INS_AND,0x29,M6502_ADDRMODE::ADR_IMM,2,2);
    setOp(M6502_INST::INS_AND,0x25,M6502_ADDRMODE::ADR_ZP,2,3);
    setOp(M6502_INST::INS_AND,0x35,M6502_ADDRMODE::ADR_ZPX,2,4);
    setOp(M6502_INST::INS_AND,0x2D,M6502_ADDRMODE::ADR_ABS,3,4);
    setOp(M6502_INST::INS_AND,0x3D,M6502_ADDRMODE::ADR_ABSX,3,4);
    setOp(M6502_INST::INS_AND,0x39,M6502_ADDRMODE::ADR_ABSY,3,4);
    setOp(M6502_INST::INS_AND,0x21,M6502_ADDRMODE::ADR_PREIDXIND,2,6);
    setOp(M6502_INST::INS_AND,0x31,M6502_ADDRMODE::ADR_POSTIDXIND,2,5);

    // ASL:
    setOp(M6502_INST::INS_ASLA,0x0A,M6502_ADDRMODE::ADR_ACC,1,2);
    setOp(M6502_INST::INS_ASL,0x06,M6502_ADDRMODE::ADR_ZP,2,5);
    setOp(M6502_INST::INS_ASL,0x16,M6502_ADDRMODE::ADR_ZPX,2,6);
    setOp(M6502_INST::INS_ASL,0x0E,M6502_ADDRMODE::ADR_ABS,3,6);
    setOp(M6502_INST::INS_ASL,0x1E,M6502_ADDRMODE::ADR_ABSX,3,7);

    // BCC:
    setOp(M6502_INST::INS_BCC,0x90,M6502_ADDRMODE::ADR_REL,2,2);

    // BCS:
    setOp(M6502_INST::INS_BCS,0xB0,M6502_ADDRMODE::ADR_REL,2,2);

    // BEQ:
    setOp(M6502_INST::INS_BEQ,0xF0,M6502_ADDRMODE::ADR_REL,2,2);

    // BIT:
    setOp(M6502_INST::INS_BIT,0x24,M6502_ADDRMODE::ADR_ZP,2,3);
    setOp(M6502_INST::INS_BIT,0x2C,M6502_ADDRMODE::ADR_ABS,3,4);

    // BMI:
    setOp(M6502_INST::INS_BMI,0x30,M6502_ADDRMODE::ADR_REL,2,2);

    // BNE:
    setOp(M6502_INST::INS_BNE,0xD0,M6502_ADDRMODE::ADR_REL,2,2);

    // BPL:
    setOp(M6502_INST::INS_BPL,0x10,M6502_ADDRMODE::ADR_REL,2,2);

    // BRK:
    setOp(M6502_INST::INS_BRK,0x00,M6502_ADDRMODE::ADR_IMP,1,7);

    // BVC:
    setOp(M6502_INST::INS_BVC,0x50,M6502_ADDRMODE::ADR_REL,2,2);

    // BVS:
    setOp(M6502_INST::INS_BVS,0x70,M6502_ADDRMODE::ADR_REL,2,2);

    // CLC:
    setOp(M6502_INST::INS_CLC,0x18,M6502_ADDRMODE::ADR_IMP,1,2);

    // CLD:
    setOp(M6502_INST::INS_CLD,0xD8,M6502_ADDRMODE::ADR_IMP,1,2);

    // CLI:
    setOp(M6502_INST::INS_CLI,0x58,M6502_ADDRMODE::ADR_IMP,1,2);

    // CLV:
    setOp(M6502_INST::INS_CLV,0xB8,M6502_ADDRMODE::ADR_IMP,1,2);

    // CMP:
    setOp(M6502_INST::INS_CMP,0xC9,M6502_ADDRMODE::ADR_IMM,2,2);
    setOp(M6502_INST::INS_CMP,0xC5,M6502_ADDRMODE::ADR_ZP,2,3);
    setOp(M6502_INST::INS_CMP,0xD5,M6502_ADDRMODE::ADR_ZPX,2,4);
    setOp(M6502_INST::INS_CMP,0xCD,M6502_ADDRMODE::ADR_ABS,3,4);
    setOp(M6502_INST::INS_CMP,0xDD,M6502_ADDRMODE::ADR_ABSX,3,4);
    setOp(M6502_INST::INS_CMP,0xD9,M6502_ADDRMODE::ADR_ABSY,3,4);
    setOp(M6502_INST::INS_CMP,0xC1,M6502_ADDRMODE::ADR_PREIDXIND,2,6);
    setOp(M6502_INST::INS_CMP,0xD1,M6502_ADDRMODE::ADR_POSTIDXIND,2,5);

    // CPX:
    setOp(M6502_INST::INS_CPX,0xE0,M6502_ADDRMODE::ADR_IMM,2,2);
    setOp(M6502_INST::INS_CPX,0xE4,M6502_ADDRMODE::ADR_ZP,2,3);
    setOp(M6502_INST::INS_CPX,0xEC,M6502_ADDRMODE::ADR_ABS,3,4);

    // CPY:
    setOp(M6502_INST::INS_CPY,0xC0,M6502_ADDRMODE::ADR_IMM,2,2);
    setOp(M6502_INST::INS_CPY,0xC4,M6502_ADDRMODE::ADR_ZP,2,3);
    setOp(M6502_INST::INS_CPY,0xCC,M6502_ADDRMODE::ADR_ABS,3,4);

    // DEC:
    setOp(M6502_INST::INS_DEC,0xC6,M6502_ADDRMODE::ADR_ZP,2,5);
    setOp(M6502_INST::INS_DEC,0xD6,M6502_ADDRMODE::ADR_ZPX,2,6);
    setOp(M6502_INST::INS_DEC,0xCE,M6502_ADDRMODE::ADR_ABS,3,6);
    setOp(M6502_INST::INS_DEC,0xDE,M6502_ADDRMODE::ADR_ABSX,3,7);

    // DEX:
    setOp(M6502_INST::INS_DEX,0xCA,M6502_ADDRMODE::ADR_IMP,1,2);

    // DEY:
    setOp(M6502_INST::INS_DEY,0x88,M6502_ADDRMODE::ADR_IMP,1,2);

    // EOR:
    setOp(M6502_INST::INS_EOR,0x49,M6502_ADDRMODE::ADR_IMM,2,2);
    setOp(M6502_INST::INS_EOR,0x45,M6502_ADDRMODE::ADR_ZP,2,3);
    setOp(M6502_INST::INS_EOR,0x55,M6502_ADDRMODE::ADR_ZPX,2,4);
    setOp(M6502_INST::INS_EOR,0x4D,M6502_ADDRMODE::ADR_ABS,3,4);
    setOp(M6502_INST::INS_EOR,0x5D,M6502_ADDRMODE::ADR_ABSX,3,4);
    setOp(M6502_INST::INS_EOR,0x59,M6502_ADDRMODE::ADR_ABSY,3,4);
    setOp(M6502_INST::INS_EOR,0x41,M6502_ADDRMODE::ADR_PREIDXIND,2,6);
    setOp(M6502_INST::INS_EOR,0x51,M6502_ADDRMODE::ADR_POSTIDXIND,2,5);

    // INC:
    setOp(M6502_INST::INS_INC,0xE6,M6502_ADDRMODE::ADR_ZP,2,5);
    setOp(M6502_INST::INS_INC,0xF6,M6502_ADDRMODE::ADR_ZPX,2,6);
    setOp(M6502_INST::INS_INC,0xEE,M6502_ADDRMODE::ADR_ABS,3,6);
    setOp(M6502_INST::INS_INC,0xFE,M6502_ADDRMODE::ADR_ABSX,3,7);

    // INX:
    setOp(M6502_INST::INS_INX,0xE8,M6502_ADDRMODE::ADR_IMP,1,2);

    // INY:
    setOp(M6502_INST::INS_INY,0xC8,M6502_ADDRMODE::ADR_IMP,1,2);

    // JMP:
    setOp(M6502_INST::INS_JMP,0x4C,M6502_ADDRMODE::ADR_ABS,3,3);
    setOp(M6502_INST::INS_JMP,0x6C,M6502_ADDRMODE::ADR_IND/*ABS*/,3,5);

    // JSR:
    setOp(M6502_INST::INS_JSR,0x20,M6502_ADDRMODE::ADR_ABS,3,6);

    // LDA:
    setOp(M6502_INST::INS_LDA,0xA9,M6502_ADDRMODE::ADR_IMM,2,2);
    setOp(M6502_INST::INS_LDA,0xA5,M6502_ADDRMODE::ADR_ZP,2,3);
    setOp(M6502_INST::INS_LDA,0xB5,M6502_ADDRMODE::ADR_ZPX,2,4);
    setOp(M6502_INST::INS_LDA,0xAD,M6502_ADDRMODE::ADR_ABS,3,4);
    setOp(M6502_INST::INS_LDA,0xBD,M6502_ADDRMODE::ADR_ABSX,3,4);
    setOp(M6502_INST::INS_LDA,0xB9,M6502_ADDRMODE::ADR_ABSY,3,4);
    setOp(M6502_INST::INS_LDA,0xA1,M6502_ADDRMODE::ADR_PREIDXIND,2,6);
    setOp(M6502_INST::INS_LDA,0xB1,M6502_ADDRMODE::ADR_POSTIDXIND,2,5);


    // LDX:
    setOp(M6502_INST::INS_LDX,0xA2,M6502_ADDRMODE::ADR_IMM,2,2);
    setOp(M6502_INST::INS_LDX,0xA6,M6502_ADDRMODE::ADR_ZP,2,3);
    setOp(M6502_INST::INS_LDX,0xB6,M6502_ADDRMODE::ADR_ZPY,2,4);
    setOp(M6502_INST::INS_LDX,0xAE,M6502_ADDRMODE::ADR_ABS,3,4);
    setOp(M6502_INST::INS_LDX,0xBE,M6502_ADDRMODE::ADR_ABSY,3,4);

    // LDY:
    setOp(M6502_INST::INS_LDY,0xA0,M6502_ADDRMODE::ADR_IMM,2,2);
    setOp(M6502_INST::INS_LDY,0xA4,M6502_ADDRMODE::ADR_ZP,2,3);
    setOp(M6502_INST::INS_LDY,0xB4,M6502_ADDRMODE::ADR_ZPX,2,4);
    setOp(M6502_INST::INS_LDY,0xAC,M6502_ADDRMODE::ADR_ABS,3,4);
    setOp(M6502_INST::INS_LDY,0xBC,M6502_ADDRMODE::ADR_ABSX,3,4);

    // LSR:
    setOp(M6502_INST::INS_LSRA,0x4A,M6502_ADDRMODE::ADR_ACC,1,2);
    setOp(M6502_INST::INS_LSR,0x46,M6502_ADDRMODE::ADR_ZP,2,5);
    setOp(M6502_INST::INS_LSR,0x56,M6502_ADDRMODE::ADR_ZPX,2,6);
    setOp(M6502_INST::INS_LSR,0x4E,M6502_ADDRMODE::ADR_ABS,3,6);
    setOp(M6502_INST::INS_LSR,0x5E,M6502_ADDRMODE::ADR_ABSX,3,7);

    // NOP:
    setOp(M6502_INST::INS_NOP,0xEA,M6502_ADDRMODE::ADR_IMP,1,2);

    // ORA:
    setOp(M6502_INST::INS_ORA,0x09,M6502_ADDRMODE::ADR_IMM,2,2);
    setOp(M6502_INST::INS_ORA,0x05,M6502_ADDRMODE::ADR_ZP,2,3);
    setOp(M6502_INST::INS_ORA,0x15,M6502_ADDRMODE::ADR_ZPX,2,4);
    setOp(M6502_INST::INS_ORA,0x0D,M6502_ADDRMODE::ADR_ABS,3,4);
    setOp(M6502_INST::INS_ORA,0x1D,M6502_ADDRMODE::ADR_ABSX,3,4);
    setOp(M6502_INST::INS_ORA,0x19,M6502_ADDRMODE::ADR_ABSY,3,4);
    setOp(M6502_INST::INS_ORA,0x01,M6502_ADDRMODE::ADR_PREIDXIND,2,6);
    setOp(M6502_INST::INS_ORA,0x11,M6502_ADDRMODE::ADR_POSTIDXIND,2,5);

    // PHA:
    setOp(M6502_INST::INS_PHA,0x48,M6502_ADDRMODE::ADR_IMP,1,3);

    // PHP:
    setOp(M6502_INST::INS_PHP,0x08,M6502_ADDRMODE::ADR_IMP,1,3);

    // PLA:
    setOp(M6502_INST::INS_PLA,0x68,M6502_ADDRMODE::ADR_IMP,1,4);

    // PLP:
    setOp(M6502_INST::INS_PLP,0x28,M6502_ADDRMODE::ADR_IMP,1,4);

    // ROL:
    setOp(M6502_INST::INS_ROLA,0x2A,M6502_ADDRMODE::ADR_ACC,1,2);
    setOp(M6502_INST::INS_ROL,0x26,M6502_ADDRMODE::ADR_ZP,2,5);
    setOp(M6502_INST::INS_ROL,0x36,M6502_ADDRMODE::ADR_ZPX,2,6);
    setOp(M6502_INST::INS_ROL,0x2E,M6502_ADDRMODE::ADR_ABS,3,6);
    setOp(M6502_INST::INS_ROL,0x3E,M6502_ADDRMODE::ADR_ABSX,3,7);

    // ROR:
    setOp(M6502_INST::INS_RORA,0x6A,M6502_ADDRMODE::ADR_ACC,1,2);
    setOp(M6502_INST::INS_ROR,0x66,M6502_ADDRMODE::ADR_ZP,2,5);
    setOp(M6502_INST::INS_ROR,0x76,M6502_ADDRMODE::ADR_ZPX,2,6);
    setOp(M6502_INST::INS_ROR,0x6E,M6502_ADDRMODE::ADR_ABS,3,6);
    setOp(M6502_INST::INS_ROR,0x7E,M6502_ADDRMODE::ADR_ABSX,3,7);

    // RTI:
    setOp(M6502_INST::INS_RTI,0x40,M6502_ADDRMODE::ADR_IMP,1,6);

    // RTS:
    setOp(M6502_INST::INS_RTS,0x60,M6502_ADDRMODE::ADR_IMP,1,6);

    // SBC:
    setOp(M6502_INST::INS_SBC,0xE9,M6502_ADDRMODE::ADR_IMM,2,2);
    setOp(M6502_INST::INS_SBC,0xE5,M6502_ADDRMODE::ADR_ZP,2,3);
    setOp(M6502_INST::INS_SBC,0xF5,M6502_ADDRMODE::ADR_ZPX,2,4);
    setOp(M6502_INST::INS_SBC,0xED,M6502_ADDRMODE::ADR_ABS,3,4);
    setOp(M6502_INST::INS_SBC,0xFD,M6502_ADDRMODE::ADR_ABSX,3,4);
    setOp(M6502_INST::INS_SBC,0xF9,M6502_ADDRMODE::ADR_ABSY,3,4);
    setOp(M6502_INST::INS_SBC,0xE1,M6502_ADDRMODE::ADR_PREIDXIND,2,6);
    setOp(M6502_INST::INS_SBC,0xF1,M6502_ADDRMODE::ADR_POSTIDXIND,2,5);

    // SEC:
    setOp(M6502_INST::INS_SEC,0x38,M6502_ADDRMODE::ADR_IMP,1,2);

    // SED:
    setOp(M6502_INST::INS_SED,0xF8,M6502_ADDRMODE::ADR_IMP,1,2);

    // SEI:
    setOp(M6502_INST::INS_SEI,0x78,M6502_ADDRMODE::ADR_IMP,1,2);

    // STA:
    setOp(M6502_INST::INS_STA,0x85,M6502_ADDRMODE::ADR_ZP,2,3);
    setOp(M6502_INST::INS_STA,0x95,M6502_ADDRMODE::ADR_ZPX,2,4);
    setOp(M6502_INST::INS_STA,0x8D,M6502_ADDRMODE::ADR_ABS,3,4);
    setOp(M6502_INST::INS_STA,0x9D,M6502_ADDRMODE::ADR_ABSX,3,5);
    setOp(M6502_INST::INS_STA,0x99,M6502_ADDRMODE::ADR_ABSY,3,5);
    setOp(M6502_INST::INS_STA,0x81,M6502_ADDRMODE::ADR_PREIDXIND,2,6);
    setOp(M6502_INST::INS_STA,0x91,M6502_ADDRMODE::ADR_POSTIDXIND,2,6);

    // STX:
    setOp(M6502_INST::INS_STX,0x86,M6502_ADDRMODE::ADR_ZP,2,3);
    setOp(M6502_INST::INS_STX,0x96,M6502_ADDRMODE::ADR_ZPY,2,4);
    setOp(M6502_INST::INS_STX,0x8E,M6502_ADDRMODE::ADR_ABS,3,4);

    // STY:
    setOp(M6502_INST::INS_STY,0x84,M6502_ADDRMODE::ADR_ZP,2,3);
    setOp(M6502_INST::INS_STY,0x94,M6502_ADDRMODE::ADR_ZPX,2,4);
    setOp(M6502_INST::INS_STY,0x8C,M6502_ADDRMODE::ADR_ABS,3,4);

    // TAX:
    setOp(M6502_INST::INS_TAX,0xAA,M6502_ADDRMODE::ADR_IMP,1,2);

    // TAY:
    setOp(M6502_INST::INS_TAY,0xA8,M6502_ADDRMODE::ADR_IMP,1,2);

    // TSX:
    setOp(M6502_INST::INS_TSX,0xBA,M6502_ADDRMODE::ADR_IMP,1,2);

    // TXA:
    setOp(M6502_INST::INS_TXA,0x8A,M6502_ADDRMODE::ADR_IMP,1,2);

    // TXS:
    setOp(M6502_INST::INS_TXS,0x9A,M6502_ADDRMODE::ADR_IMP,1,2);

    // TYA:
    setOp(M6502_INST::INS_TYA,0x98,M6502_ADDRMODE::ADR_IMP,1,2);
}
