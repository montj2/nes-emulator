...
#define ERROR_IF(E, TYPE, SUBTYPE) if (E) ERROR(TYPE, SUBTYPE)
#define ERROR_UNLESS(E, TYPE, SUBTYPE) if (!(E)) ERROR(TYPE, SUBTYPE)

#define FATAL_ERROR(TYPE, SUBTYPE) debug::fatalError(TYPE, SUBTYPE, _CRT_WIDE(__FILE__), _CRT_WIDE(__FUNCTION__), __LINE__)
#define FATAL_ERROR_IF(E, TYPE, SUBTYPE) if (E) FATAL_ERROR(TYPE, SUBTYPE)
#define FATAL_ERROR_UNLESS(E, TYPE, SUBTYPE) if (!(E)) FATAL_ERROR(TYPE, SUBTYPE)
